...
import '../../../components/no_results_placeholder.dart';
      ...
      child: RefreshIndicator(
        ...
        child: BlocBuilder<BookSearchBloc, BookSearchState>(
          builder: (context, state) {
            ...
            SearchStateError() => ErrorPlaceholder(message: state.error, onRetryClicked: () => context.read<BookSearchBloc>().add(const BooksRequested()),),
